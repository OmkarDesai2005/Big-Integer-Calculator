...
string divide(const string& str1, const string& str2)
{
    if (str2 == "0" || str2 == "-0")
    ...
    string divisor = neg2 ? str2.substr(1) : str2;
    ...
    if (compareNumbers(dividend, divisor) < 0)
        return "0";
    ...
    for (int i = 0; i < dividend.size(); i++)
    {
        ...
        // Binary search quotient digit [0, 9]
        int lo = 0;
        int hi = 9;
        int best = 0;
